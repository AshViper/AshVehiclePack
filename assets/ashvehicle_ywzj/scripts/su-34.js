function updateBones(context) {
    ...
    builder.setRotation("FLFlap", -pitchInput * 12, 0, 0)
    builder.setRotation("FRFLap", -pitchInput * 12, 0, 0)
    ...
    builder.setRotation("VBLFlap", 0, -yawInput * 12, 0)
    builder.setRotation("VBRFlap", 0, -yawInput * 12, 0)
    return builder
}
